...
const  { createPost, updatePost, deletePost, getPost, getAllPosts } =require ('../controller/post-controller.js');
...
const  { loginUser, singupUser, logoutUser } =require ('../controller/user-controller.js');
